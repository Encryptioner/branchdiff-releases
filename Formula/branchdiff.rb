class Branchdiff < Formula
  ...
  on_macos do
    ...
    sha256 "aa62cae5fcbe1995b871f9d8176bb314890be0d83ebedd61a9dafa3656f8e9be"
  end

  on_linux do
    on_arm do
      url "https://github.com/encryptioner/branchdiff-releases/releases/download/v#{version}/branchdiff-linux-arm64"
      sha256 "e935cb25b615fbe8cb296739bae6549237db0609d40f298dee2c993dddf9afa5"
    end
    on_intel do
      url "https://github.com/encryptioner/branchdiff-releases/releases/download/v#{version}/branchdiff-linux-x64"
      sha256 "956da93c433385f200c4287d7e95c6e30966b042838cc873c02bb1464c178a0f"
    end
  end
