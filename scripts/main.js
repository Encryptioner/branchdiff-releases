...
const INSTALLERS = {
  npm: {
    ...
    tabs: [
      ...
      { label: 'pnpm', cmd: 'pnpm install -g @encryptioner/branchdiff@latest' },
  ...
  pip: {
    ...
    tabs: [
      ...
      { label: 'uv', cmd: 'uv tool install --upgrade branchdiff' },
      { label: 'pipx', cmd: 'pipx install --upgrade branchdiff' },
    ],
